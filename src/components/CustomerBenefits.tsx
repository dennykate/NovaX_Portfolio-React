import { CustomerBenefitCard, WaypointContainer } from ".";
import { customerBenefitsData } from "../constants";
import { CardProps } from "../types";
import { Fade, FadeLeft } from "./FramerAnimation";

const CustomerBenefits = () => {
  return (
    <WaypointContainer name="benefits">
      <div id="benefits" className="custom-main-container relative">
        ...
        <div className="custom-container ">
          <FadeLeft>
            ...
            <div className="max-w-[840px] mx-auto mb-5">
              <p className="paragraph-2 md:text-center  sm:text-start lg:px-0 sm:px-5 px-2 text-justify">
                Experience enhanced user delight through personalized efficiency
                and convenience while enjoying savings, rewards, and
                accessibility, supported by innovation and reliability,
                unlocking limitless growth opportunities
              </p>
            </div>
          </FadeLeft>
