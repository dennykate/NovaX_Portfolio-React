...
const OurValue = () => {
  return (
    <div className="custom-main-container relative">
      ...
      <div className="custom-container flex items-start justify-center gap-5 lg:flex-row flex-col lg:px-0 sm:px-5 px-2">
        ...
        <div className="lg:w-1/2 w-full flex flex-col items-start lg:gap-5 gap-3">
          <h3 className="heading-2 uppercase  custom-text-shadow">Our Value</h3>
